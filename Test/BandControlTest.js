    ...
    describe("#BandList", () => {
        ...
        describe('#seperateSupportAndResistance', () => {
            ...
            it('s and r\'s bands provide the same data that is in the old', () => {
                ...
                assert.equal(sr.resistance[sr.resistance.length - 1].count, bandlist[bandlist.length - 1].count);
                assert.equal(sr.resistance[sr.resistance.length - 1].rank, bandlist[bandlist.length - 1].rank);
